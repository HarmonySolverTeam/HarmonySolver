...
const validateDelayWithOtherAttributesTest = () => {
    var hf1 = new HarmonicFunction.HarmonicFunctionWithoutValidation("T",1,undefined,"1",[["4","3"]],["7"],[],false,undefined,undefined);
    var hf2 = new HarmonicFunction.HarmonicFunctionWithoutValidation("T",1,undefined,"3",[["4","3"]],["7"],[],false,undefined,undefined);
    var hf3 = new HarmonicFunction.HarmonicFunctionWithoutValidation("T",1,undefined,"1",[["4","3"]],["7"],[],false,undefined,undefined);
    var hf4 = new HarmonicFunction.HarmonicFunctionWithoutValidation("T",1,undefined,"1",[["6","5"]],[],["5"],false,undefined,undefined);
    var hf5 = new HarmonicFunction.HarmonicFunctionWithoutValidation("T",1,undefined,"1",[["4","3"]],["7","9"],["5"],false,undefined,undefined);
    return TestUtils.assertTrue(validator.validate(hf1)) &&
        TestUtils.assertTrue(validator.validate(hf2)) &&
